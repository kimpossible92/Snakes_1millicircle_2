...
{	
	...
	public class OnlineLobbyUI : MonoBehaviour
	{
		...
		public virtual void ShowMainMenu()
		{
			...
			MatchmakingButton.onClick.AddListener(OnlineLobbyMst.Instance.OnMatchmaking);

			DirectConnectionButton.onClick.RemoveAllListeners();
			DirectConnectionButton.onClick.AddListener(OnlineLobbyMst.Instance.OnDirectConnection);

			BackButton.onClick.RemoveAllListeners();
			BackButton.onClick.AddListener(OnlineLobbyMst.Instance.ReturnToStartScreen);
		}
		...
		public virtual void ShowMatchmaking()
		{
			...
			RefreshOnlineMatchesButton.onClick.AddListener(OnlineLobbyMst.Instance.OnClickRefreshServerList);

			CreateMatchButton.onClick.RemoveAllListeners();
			CreateMatchButton.onClick.AddListener(OnlineLobbyMst.Instance.OnClickCreateMatchmakingGame);

			MMReturnToMainButton.onClick.RemoveAllListeners();
			MMReturnToMainButton.onClick.AddListener(OnlineLobbyMst.Instance.OnReturnToMain);
		}
		...
		public virtual void ShowMatchesFromMatchmaking(List<MatchInfoSnapshot> matches)
		{
			for(int i = 0; i < matches.Count; i++)
			{
				...
				entry.GetComponent<OnlineLobbyMatchEntry>().Init(matches[i], OnlineLobbyMst.Instance);
		...
		public virtual void ShowDirectConnection()
		{
			...
			JoinServerButton.onClick.AddListener(
				delegate {OnlineLobbyMst.Instance.OnClickJoinServer(ServerAdressInput.text);}
			);

			StartServerButton.onClick.RemoveAllListeners();
			StartServerButton.onClick.AddListener(OnlineLobbyMst.Instance.OnClickStartHost);

			DirectReturnToMainButton.onClick.RemoveAllListeners();
			DirectReturnToMainButton.onClick.AddListener(OnlineLobbyMst.Instance.OnReturnToMain);
		}
		...
		public virtual void ShowConnected()
		{
			...
			OnlineReturnToMainButton.onClick.AddListener(OnlineLobbyMst.Instance.OnConnectedReturnToMain);
		}
		...
		{
			TrackImage.sprite = OnlineLobbyMst.Instance.AvailableTracksSprite[currentTrack];
			TrackNameText.text = OnlineLobbyMst.Instance.AvailableTracksSceneName[currentTrack];	
		}
		...
		public virtual void ShowStartGame()
		{
			...
			StartGameButton.onClick.AddListener(OnlineLobbyMst.Instance.OnStartGame);
		}
